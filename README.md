...
**Proxy**
Telegram bot can also work behind a proxy. Proxy url look like: `http://PROXY_HOST:PROXY_PORT/` or `socks5://URL_OF_THE_PROXY_SERVER:PROXY_PORT` with optional optional authentication.
